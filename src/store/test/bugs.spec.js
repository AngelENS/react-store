    ...
    describe("loading bugs", () => {
        ...
        describe("if the bugs don't exist in the cache", () => {
            ...
            describe("loading indicator", () => {
                it("should be true while featching the bugs", () => {
                ...
                it("should be false after the bugs are featch", async () => {
                    fakeAxios.onGet("/bugs").reply(() => { return [200, [{ id: 1 }]] });
                ...
                it("should be false after if the server return an error", async () => {
